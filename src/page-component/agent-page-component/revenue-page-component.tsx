import { Card, CardBody, chakra, Divider, Heading, HStack, Icon, SimpleGrid, Text, useColorModeValue } from '@chakra-ui/react'
...
const AgentRevenuePageComponent = () => {
    return (
        <>
            <chakra.h1 textAlign={'center'} fontSize={'4xl'} py={10} fontWeight={'bold'}>
                Hi Agent, that's your revenue statistics
            </chakra.h1>
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={{ base: 5, lg: 8 }}>
                ...
                <StatsCard
                    title={'Balance'}
                    stat={Number('200').toLocaleString('en-Us', { style: 'currency', currency: 'USD' })}
            ...
            <Card mt={20}>
                <CardBody>
                    <HStack justify={'space-between'}>
                        ...
                        <Icon as={FaFunnelDollar} fontSize={60} color={'facebook'} />
                    </HStack>
                    ...
                    <HStack justify={'space-between'}>
                        <Heading fontFamily={'mono'} letterSpacing={5}>Pending balance</Heading>
                        <Text fontSize={40}>
                    ...
                    <Divider my={6} borderColor={useColorModeValue('blackAlpha.600', '')} />
                    <HStack justify={'space-between'}>
                        <Heading fontFamily={'mono'} letterSpacing={5}>Payouts</Heading>
                        <Icon as={FiSettings} fontSize={60} color={'facebook'} cursor={'pointer'} />
                    </HStack>
...
export default AgentRevenuePageComponent
